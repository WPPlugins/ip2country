...
Plugin URI: http://wordpress.org/extend/plugins/ip2country/
...
function ip2country_unqprfx_plugin_meta( $links, $file ) { // add 'Support' and 'Donate' links to plugin meta row
	if ( strpos( $file, 'ip2country.php' ) !== false ) {
		$links = array_merge( $links, array( '<a href="http://web-profile.com.ua/wordpress/plugins/ip2country/" title="Need help?">' . __('Support') . '</a>' ) );
